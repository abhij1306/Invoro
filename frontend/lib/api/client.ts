...
async function parseResponseBody<T>(response: Response, responseKind: ResponseKind): Promise<T> {
...
function requestWithBody<T>(method: BodyRequestMethod, path: string, body: unknown): Promise<T> {
