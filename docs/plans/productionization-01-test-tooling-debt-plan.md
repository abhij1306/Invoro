...
- Final local gates: structure regression 30 passed; collection 2,451 items, 17 deselected, 2,434 selected; scoped LOC 89,318 across 273 files (down 1,315 from baseline); zero files over 800; zero Radon callables over 15; targeted Ruff and compile checks passed.
