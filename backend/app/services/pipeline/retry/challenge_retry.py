...
retry_detail_challenge_shell_with_real_chrome = _stage._retry_detail_challenge_shell_with_real_chrome
retry_patchright_detail_rejection_with_real_chrome = _stage._retry_patchright_detail_rejection_with_real_chrome
