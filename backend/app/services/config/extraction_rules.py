...
DETAIL_LOW_SIGNAL_ZERO_PRICE_SOURCE_SET = frozenset(
    globals().get("DETAIL_LOW_SIGNAL_ZERO_PRICE_SOURCES", ())
)
...
DETAIL_PRICE_JSONLD_RE = re.compile(
    str(globals().get("DETAIL_PRICE_JSONLD_PATTERN", r"\bprice\b"))
)
DETAIL_CURRENCY_JSONLD_RE = re.compile(
    str(globals().get("DETAIL_CURRENCY_JSONLD_PATTERN", r"\bpriceCurrency\b"))
)
