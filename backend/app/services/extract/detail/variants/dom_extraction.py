...
from .dom_variant_support import (
...
def extract_variants_from_dom(
    ...
    *,
    ...
    dom_group_pipeline.DOM_VARIANT_CARTESIAN_COMBO_LIMIT = (
        DOM_VARIANT_CARTESIAN_COMBO_LIMIT
    )
    dom_variant_support.VARIANT_CHOICE_OPTION_LIMIT = VARIANT_CHOICE_OPTION_LIMIT
    return dom_group_pipeline.extract_variants_from_dom(
        soup, page_url=page_url, js_state_objects=js_state_objects
    )
...
def backfill_variants_from_dom_if_missing(
    ...
    *,
    ...
    dom_variant_support.VARIANT_CHOICE_OPTION_LIMIT = VARIANT_CHOICE_OPTION_LIMIT
    dom_group_pipeline.backfill_variants_from_dom_if_missing(
