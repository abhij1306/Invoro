...
async def test_save_review_excludes_falsy_normalized_new_fields(
    ...
    monkeypatch.setattr(
        "app.services.review.load_resolved_schema", _fake_load_resolved_schema
    )
    monkeypatch.setattr(
...
async def test_promote_domain_recipe_selectors_matches_existing_selectors_by_kind(
    ...
    monkeypatch.setattr(
        "app.services.review.list_selector_records", _fake_list_selector_records
    )
    monkeypatch.setattr(
        "app.services.review.update_selector_record", _fake_update_selector_record
    )
    monkeypatch.setattr(
        "app.services.review.create_selector_record", _fake_create_selector_record
    )
...
async def test_apply_domain_recipe_field_action_rolls_back_staged_mutations_on_error(
    ...
    monkeypatch.setattr(
        "app.services.review.promote_domain_recipe_selectors", _failing_promote
    )
