...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_monitor_snapshots_monitor_id", "monitor_snapshots", ["monitor_id"]
    )
    ...
    op.create_index(
        "ix_monitor_url_states_monitor_id", "monitor_url_states", ["monitor_id"]
    )
    op.create_index(
    ...
    op.create_index(
        "ix_in_app_notifications_monitor_id", "in_app_notifications", ["monitor_id"]
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        "ix_in_app_notifications_monitor_id", table_name="in_app_notifications"
    )
    ...
    op.drop_index(
        "ix_monitor_snapshot_records_monitor_id", table_name="monitor_snapshot_records"
    )
